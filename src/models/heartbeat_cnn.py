...
class HeartbeatCNN(nn.Module):
    def __init__(self):
        ...
        self.conv2 = nn.Conv2d(8, 16, (3, 2), stride=(1, 1))
        self.conv3 = nn.Conv2d(16, 32, (1, 2), stride=(1, 1))
        self.conv4 = nn.Conv2d(32, 64, (1, 2), stride=(1, 1))
        self.conv5 = nn.Conv2d(64, 128, (1, 2), stride=(1, 1))
        self.conv6 = nn.Conv2d(128, 256, (1, 2), stride=(1, 1))
        self.conv7 = nn.Conv2d(256, 512, (1, 2), stride=(1, 1))
        self.conv8 = nn.Conv2d(512, 1024, (1, 2), stride=(1, 1))
        self.conv9 = nn.Conv2d(1024, 2048, (1, 2), stride=(1, 1))
        self.conv10 = nn.Conv2d(2048, 32, (1, 1), stride=(1, 1))
        self.pool = nn.MaxPool2d((1, 2), (1, 2))
        self.flatten = nn.Flatten()
        self.fc1 = nn.Linear(225, 64)
